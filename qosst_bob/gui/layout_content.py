...
SEQUENCE = [111, 111, 116, 116, 113, 114, 113, 114, 98, 97]
...
class QOSSTGUIText(QOSSTGUIContent):
    ...
    LENGTH_RAW_KEY = "-LENGTH-RAW-KEY-"
    LENGTH_RECONCILED_KEY = "-LENGTH-RECONCILED-KEY-"
    LENGTH_FINAL_KEY = "-LENGTH-FINAL-KEY-"
